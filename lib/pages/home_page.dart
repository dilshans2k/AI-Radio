...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "4add8a86a290db5f7d6f8927937dceaa2e956eca572e1d8b807a3e2338fdd0dc/stage",
  ...
  _playMusic(String url) {
    ...
    _currPlaying = radios.firstWhere((element) => element.url == url);
        ...
        children: [
          ...
          radios != null
              ? VxSwiper.builder(
                  ...
                  aspectRatio: 1,
                  // aspectRatio: context.mdWindowSize == Mobi
                  //     ? 1.0
          ...
          Align(
            ...
            child: [
              if (_isPlaying)
                "Playing Now - ${_currPlaying.name} FM"
                    .text
                    .white
                    .makeCentered(),
              Icon(
